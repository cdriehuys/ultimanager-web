...
describe('List Component', () => {
  ...
  describe('ListWrapper', () => {
    it('should not have a color if the error prop is not passed', () => {
      const wrapper = shallow(<ListWrapper theme={theme} />);

      expect(wrapper).toHaveStyleRule('color', 'unset');
    });

    it('should have be rendered in an error color if the error prop is true', () => {
      const wrapper = shallow(<ListWrapper error theme={theme} />);

      expect(wrapper).toHaveStyleRule('color', theme.colors.error);
    });
  });
});
